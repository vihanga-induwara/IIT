...
import { ExpoImage, Icon, withTheme } from '@draftbit/ui';
...
const ReportBlock = props => {
  ...
  return (
    ...
    >
      <View style={StyleSheet.applyWidth({ marginRight: 0 }, dimensions.width)}>
        <ExpoImage
      ...
      <View>
        ...
        <View
          style={StyleSheet.applyWidth(
            { flex: 1, flexDirection: 'row', marginBottom: 10, marginLeft: 10 },
            dimensions.width
          )}
        >
...
export default withTheme(ReportBlock);
